...
public class Problem1 {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= T; i++){
            N = sc.nextInt();
            int mulNum = 0, checkBit = 0;
            while(!checking(checkBit)) {
                mulNum++;
                int nowNum = N * mulNum;
                while (nowNum > 0) {
                    checkBit |= 1 << nowNum % 10;
                    nowNum /= 10;
                }
            }

            System.out.println("#" + i + " " + N * mulNum);
        }

    }

    public static boolean checking(int checkBit){
        return (checkBit & 0b1111111111) == 0b1111111111;
    }
}*/
